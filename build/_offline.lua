...
-- luacheck: push ignore install_manifest frcms_offline app_files dep_files lgray green white
...
local function write_install()
    ...
    handle = fs.open("frcmsm.lua", "w")
    handle.write(b64_decode(frcms_offline))
    handle.close()
end
...
lgray()
print("Hint: You can use 'frcmsm' to manage your off-line installation.")
white()
