...
local function draw_computer_crash(exit)
    ...
    TextBox{parent=display,x=15,y=4,text="Please consider reporting this on the CCMEK-FRCMS Discord or GitHub.",width=36,alignment=core.ALIGN.CENTER}
...
local function draw_pocket_crash(exit)
    ...
    TextBox{parent=display,x=2,y=5,text="Consider reporting this on the CCMEK-FRCMS Discord or GitHub.",width=36,alignment=core.ALIGN.CENTER}
