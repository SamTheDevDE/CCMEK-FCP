...
function logic.update_annunciator(self)
    ...
    if plc_ready then
        ...
        -- it's a rough estimation, see GitHub CCMEK-FRCMS/wiki/High-Rate-Calculation
    ...
    for i = 1, #self.turbines do
        ...
        -- see notes at CCMEK-FRCMS/wiki/Annunciator-Panels#Generator-Trip
        annunc.GeneratorTrip[idx] = (_get_dt(DT_KEYS.TurbinePower .. idx) > 0.0) and (db.tanks.energy_fill > 0.05)

        -- see notes at CCMEK-FRCMS/wiki/Annunciator-Panels#Turbine-Trip
